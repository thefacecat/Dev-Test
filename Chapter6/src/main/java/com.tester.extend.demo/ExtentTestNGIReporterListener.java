...
/**
 * Created by Junjie Zhao on 19/10/05.
 */
public class ExtentTestNGIReporterListener implements IReporter {
    // 生成的路径以及文件名
    private static final String OUTPUT_FOLDER = "test-output/";
    //注意这里如果用index.html可能会导致testng的report会覆盖它,我们来把它改成index.html
...
//        只需要加上htmlReport.config().setResourceCDN(ResourceCDN.EXTENTERORTS);就可以解决
